...
(defvar delfos-copilot-modify-region-system-message "You will receive a buffer REGION and your task is to return a replacement that closely follows the INSTRUCTIONS. . Do not provide any explanations. Do not create code blocks: only return the text that will replace the selected region.")
(defvar delfos-copilot-modify-region-with-file-context-system-message "You will receive a buffer REGION and FILE-CONTENT to give context to that REGION. your task is to return a replacement for the REGION that closely follows the INSTRUCTIONS. Do not provide any explanations. Do not create code blocks: only return the text that will replace the selected REGION")
